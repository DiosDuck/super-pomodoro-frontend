...
import { Cycle, CycleService, cycleType, POMODORO_CYCLE_KEY } from "./cycle.service";
...
describe('Cycle Service', () => {
    ...
    it.each<NextCycleTestCase>([
        ...
        ({initialCycle, initialNumberOfCycles, expectedCycle, expectedNumberOfCycles}) => {
            let cycle : Cycle = {
